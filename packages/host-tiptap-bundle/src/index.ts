/**
 * @geoinsight/tiptap — self-contained ESM 번들.
 *
 * 호스트 앱(예: 메티)이 단일 의존으로 GeoInsight 를 통합할 수 있도록
 * @geoinsight/host-tiptap + runtime + core + data 의존을 모두 Rollup 으로 인라인.
 ...
 *
 * 호스트 사용 흐름:
 *   import { GeoInsightExtension, bootstrapGeoInsight } from '@geoinsight/tiptap';
